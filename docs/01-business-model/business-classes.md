...
**Описание:** Субъект системы. Администратор создаётся при инициализации, не может быть удалён. Пользователь без роли может войти в систему, но не имеет доступа ни к одной функции.
