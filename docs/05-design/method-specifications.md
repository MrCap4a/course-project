...
Спецификации методов, выявленных при построении диаграмм последовательности для проекта **SuperCalculator**. Каждый вызов на диаграмме последовательности соответствует методу с совпадающей сигнатурой в диаграмме классов.
