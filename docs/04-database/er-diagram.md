...
ER-диаграмма описывает физическую схему базы данных системы **SuperCalculator**. Схема состоит из 9 таблиц, объединённых в три логических блока: управление пользователями и правами, справочник материалов, формулы и расчёты.
