...
Доменная модель описывает ключевые классы предметной области системы **Calculator** и связи между ними.  
...
| User | Субъект системы с логином, паролем, опциональной ролью и флагом супер-администратора |
