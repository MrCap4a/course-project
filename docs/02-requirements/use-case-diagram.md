...
Use Case диаграмма описывает функциональные возможности системы **Calculator** с точки зрения единственного актора — Пользователя. Все варианты использования расположены внутри границы системы «Конфигурируемый калькулятор».
